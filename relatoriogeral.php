<?php
  ...
  if (!isset($_SESSION['nome']) and !isset($_SESSION['idfuncionario'])){
    ...
    $sql = "SELECT * FROM casalbrinde INNER JOIN tipobrinde ON casalbrinde.idtipobrinde = tipobrinde.idtipobrinde where tipobrinde.idtipobrinde = 28 and statusbrinde <> 'VALIDO' ORDER BY idcasalbrinde ASC";
            ...
            <div class="card">
              ...
              <div class="table-responsive">
                <table id="dtBasicExample" class="table table-hover">
                  <thead>
                    <tr>
                      <th class="border-top-0">NOME CASAL</th>
                      <th class="border-top-0">DESC. BRINDE</th>
                      <th class="border-top-0">STATUS</th>
                      <th class="border-top-0">DATA VALIDADE</th>
                    </tr>
                  </thead>
                  <tbody>
                      <?php
                          while ($row = pg_fetch_array($result)) {
                              ...
                              echo("
                                <tr>
                                  ...
                                  <td class='txt-oflo'>".$row['datavalidade']."</td>
                                </tr>
                              ");
                          }
                      ?>
