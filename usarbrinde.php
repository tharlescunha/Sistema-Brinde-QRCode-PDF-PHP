<?php
  ...
  else
  {
    ...
    $update = "UPDATE casalbrinde SET statusbrinde='CONSUMIDO' WHERE codigobrinde='$idcasalbrinde'";
    ...
    $update1 = "UPDATE dadosbrinde SET idusuariouusuou='$fun', datausuoi='$data' WHERE idcasalbrinde='$codigo'";
