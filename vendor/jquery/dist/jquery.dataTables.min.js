...
(function(h) {
  ...
  function pb(a) {
    var b = a.oClasses,
      ...
      b = h("<div/>", {
        ...
        "class": b.sFilter
      }).append(h("<label class='espaco'/>").append(j)),
      f = function() {
        var b = !this.value ?
          "" : this.value;
        b != e.sSearch && (fa(a, {
  ...
  function ob(a) {
    ...
    var i =
      h("<div><label class='espaco'/></div>").addClass(b.sLength);
  ...
  m.defaults = {
    aaData: null,
    aaSorting: [
      [0, "asc"]   //escolher qual ordem comeca a lista
    ],
    aaSortingFixed: [],
    ajax: null,
    aLengthMenu: [10, 25, 50,100], //possibilidades
    aoColumns: null,
    aoColumnDefs: null,
    aoSearchCols: [],
    ...
    iStateDuration: 7200,
    iDeferLoading: null,
    iDisplayLength: 100, //numero que comeca
    iDisplayStart: 0,
    iTabIndex: 0,
    oClasses: {},
    oLanguage: {
      ...
      sEmptyTable: "Não foi encontrado nenhum item",
      sInfo: "Mostrando _START_ de _END_ de _TOTAL_ itens",
      sInfoEmpty: "Mostrando 0 de 0 de 0 itens",
  ...
  h.extend(m.ext.classes, {
    ...
    sInfo: "dataTables_info centeritem",
    sPaging: "dataTables_paginate centeritem paging_",
